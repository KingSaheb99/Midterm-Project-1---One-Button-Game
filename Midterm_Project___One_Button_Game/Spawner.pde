...
void spawner()
{
  ...
  else if(millis() > trackPlayMarkTime + 13100 - travelTime && spawn39)
  {
    notes.add(new Note(width + 100, height/8, 1));
    spawn39 = false;
    spawn40 = true;
  }
  else if(millis() > trackPlayMarkTime + 13207 - travelTime && spawn40)
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn40 = false;
    spawn41 = true;
  }
  else if(millis() > trackPlayMarkTime + 13314 - travelTime && spawn41)
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn41 = false;
    spawn42 = true;
  }
  else if(millis() > trackPlayMarkTime + 13421 - travelTime && spawn42)
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn42 = false;
    spawn43 = true;
  }
  else if(millis() > trackPlayMarkTime + 13528 - travelTime && spawn43)
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn43 = false;
    spawn44 = true;
  }
  else if(millis() > trackPlayMarkTime + 13635 - travelTime && spawn44)
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn44 = false;
    spawn45 = true;
  }
  else if(millis() > trackPlayMarkTime + 13742 - travelTime && spawn45)
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn45 = false;
    spawn46 = true;
  }
  else if(millis() > trackPlayMarkTime + 13849 - travelTime && spawn46)
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn46 = false;
    spawn47 = true;
  ...
  else if(millis() > trackPlayMarkTime + 14062 - travelTime && spawn47)
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn47 = false;
    spawn48 = true;
  }
  else if(millis() > trackPlayMarkTime + 14275 - travelTime && spawn48)
  {
    notes.add(new Note(width + 100, height/8, 1));
    spawn48 = false;
    spawn49 = true;
  ...
  else if(millis() > trackPlayMarkTime + 14382 - travelTime && spawn49) 
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn49 = false;
    spawn50 = true;
  }
  else if(millis() > trackPlayMarkTime + 14595 - travelTime && spawn50)
  {
    notes.add(new Note(width + 100, height/8, 1));
    spawn50 = false;
    spawn51 = true;
  }
  else if(millis() > trackPlayMarkTime + 14808 - travelTime && spawn51) 
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn51 = false;
    spawn52 = true;
  }
  else if(millis() > trackPlayMarkTime + 15021 - travelTime && spawn52)
  {
    notes.add(new Note(width + 100, height/8, 1));
    spawn52 = false;
    spawn53 = true;
  }
  else if(millis() > trackPlayMarkTime + 15234 - travelTime && spawn53) 
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn53 = false;
    spawn54 = true;
  }
  else if(millis() > trackPlayMarkTime + 15341 - travelTime && spawn54)
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn54 = false;
    spawn55 = true;
  }
  else if(millis() > trackPlayMarkTime + 15448 - travelTime && spawn55) 
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn55 = false;
    spawn56 = true;
  }
  else if(millis() > trackPlayMarkTime + 15555 - travelTime && spawn56)
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn56 = false;
    spawn57 = true;
  }
  else if(millis() > trackPlayMarkTime + 15662 - travelTime && spawn57) 
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn57 = false;
    spawn58 = true;
  }
  else if(millis() > trackPlayMarkTime + 15769 - travelTime && spawn58)
  {
    notes.add(new Note(width + 100, height/8, 1));
    spawn58 = false;
    spawn59 = true;
  ...
  else if(millis() > trackPlayMarkTime + 15982 - travelTime && spawn59)
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn59 = false;
    spawn60 = true;
  }
  else if(millis() > trackPlayMarkTime + 16195 - travelTime && spawn60) 
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn60 = false;
    spawn61 = true;
  }
  else if(millis() > trackPlayMarkTime + 16408 - travelTime && spawn61)
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn61 = false;
    spawn62 = true;
  }
  else if(millis() > trackPlayMarkTime + 16515 - travelTime && spawn62) 
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn62 = false;
    spawn63 = true;
  }
  else if(millis() > trackPlayMarkTime + 16728 - travelTime && spawn63)
  {
    notes.add(new Note(width + 100, height/8, 1));
    spawn63 = false;
    spawn64 = true;
  }
  else if(millis() > trackPlayMarkTime + 16835 - travelTime && spawn64)
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn64 = false;
    spawn65 = true;
  }
  else if(millis() > trackPlayMarkTime + 16942 - travelTime && spawn65) 
  {
    notes.add(new Note(width + 100, height/8, 2));
    spawn65 = false;
    spawn66 = true;
  }
  else if(millis() > trackPlayMarkTime + 17049 - travelTime && spawn66)
  {
    notes.add(new Note(width + 100, height/8, 3));
    spawn66 = false;
    spawn67 = true;
